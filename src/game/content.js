...
export const RESEARCH = Object.freeze({
  ...
  "cohort-ratio-prognostics": researchDefinition({
    ...
    effect: "Exposes replication efficiency, bottleneck diagnosis, and substrate projections.",
  ...
  "ferromagnetic-phase-analysis": researchDefinition({
    ...
    requiredNaniteMs: 9_600_000_000_000_000_000_000n,
    cost: researchCost(2_400_000_000_000_000_000_000n, 8_000_000_000_000_000n),
  }),
  "atmospheric-spectroscopy": researchDefinition({
    ...
    effect: "Authorizes atmospheric capture and reveals nitrogen, oxygen, argon, and carbon signatures in Captured Atmosphere.",
    requires: ["residuum-indexing"],
    requiresDiscovery: "atmosphereDetected",
    requiresStage: 2,
    requiresSearch: 4,
    trigger: "Environmental breach exposes an inexhaustible but chemically unfamiliar gas envelope.",
    requiredNaniteMs: 14_400_000_000_000_000_000_000n,
    cost: researchCost(4_200_000_000_000_000_000_000n, 12_000_000_000_000_000n),
  }),
  "atmospheric-fractionation": researchDefinition({
    ...
    requiresDiscovery: "atmosphereDetected",
    requiresSearch: 4,
    requiredNaniteMs: 36_000_000_000_000_000_000_000n,
    cost: researchCost(10_500_000_000_000_000_000_000n, 35_000_000_000_000_000n),
  }),
});
