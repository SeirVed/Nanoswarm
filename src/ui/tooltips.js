...
export const ACTION_TOOLTIPS = Object.freeze({
  ...
  adjust: "Move one nanite into or out of this directive's target allocation. Before Parallel Directive Scheduling this changes intent only; Dispatch Assigned Cohorts launches the work.",
  ...
  "research-move": "Reorder waiting research intent. A mnemonic bank that has begun forming is physical, irreversible, and cannot move.",
  "research-cancel": "Remove waiting intent before it commits any nanites or energy. Active mnemonic formation cannot be cancelled.",
  "research-pause": "Pause or resume active mnemonic formation. Its committed nanites remain unavailable and accumulated work remains exact.",
