...
- Relative allocation exposes an exact replication-efficiency score, current bottleneck, and complete-recipe buffer. Holding 99% efficiency for 30 seconds enables Temporary Burst, which reserves every whole buffered recipe, deploys it through replication, then restores the exact previous shares and locks.
